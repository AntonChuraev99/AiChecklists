...
description: Comprehensive guide to the Koin 4.2 DI architecture in the Gisti multiplatform application
...
This document provides a comprehensive analysis of how Dependency Injection is organized and implemented in Gisti using Koin 4.2 for a Kotlin Multiplatform application.

## Overview

Gisti uses **Koin 4.2** as its dependency injection framework. The DI architecture is organized into:
